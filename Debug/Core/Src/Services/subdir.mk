...
clean-Core-2f-Src-2f-Services:
	-$(RM) ./Core/Src/Services/limit_switch_service.cyclo ./Core/Src/Services/limit_switch_service.d ./Core/Src/Services/limit_switch_service.o ./Core/Src/Services/limit_switch_service.su ./Core/Src/Services/pir__sensor_service.cyclo ./Core/Src/Services/pir__sensor_service.d ./Core/Src/Services/pir__sensor_service.o ./Core/Src/Services/pir__sensor_service.su ./Core/Src/Services/uart_protocol_service.cyclo ./Core/Src/Services/uart_protocol_service.d ./Core/Src/Services/uart_protocol_service.o ./Core/Src/Services/uart_protocol_service.su
